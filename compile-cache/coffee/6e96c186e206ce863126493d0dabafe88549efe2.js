(function() {
  module.exports = {
    apply: function() {
      var applyBackgroundColor, applyBackgroundGradient, applyBackgroundImage, applyEditorFont, applyFont, applyFontWeight, applySpaciousMode, applyTooltipContrast, applyTreeColor, body;
      ...
      applyTreeColor = function() {
        if (atom.config.get('isotope-ui.colorTreeSelection')) {
          return body.setAttribute('data-isotope-ui-treecolor', 'true');
        } else {
          return body.setAttribute('data-isotope-ui-treecolor', 'false');
        }
      };
