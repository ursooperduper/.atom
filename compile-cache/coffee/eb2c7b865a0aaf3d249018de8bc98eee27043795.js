(function() {
  ...
  describe('Autocomplete Manager', function() {
    ...
    describe("when an external provider is registered", function() {
      var SpecialProvider, provider;
      SpecialProvider = (function() {
        function SpecialProvider() {}

        SpecialProvider.prototype.id = 'my-some-provider';

        SpecialProvider.prototype.selector = '*';

        SpecialProvider.prototype.requestHandler = function(_arg) {
          var list, prefix, word, _i, _len, _results;
          prefix = _arg.prefix;
      ...
      beforeEach(function() {
        ...
        return runs(function() {
          ...
          return mainModule.consumeProvider({
            provider: provider
          });
        });
      });
      ...
      describe("when match.snippet is used", function() {
        beforeEach(function() {
          return spyOn(provider, 'requestHandler').andCallFake(function(_arg) {
        ...
        return describe("when the snippets package is enabled", function() {
          ...
          it("displays the snippet without the `${1:}` in its own class", function() {
            ...
            return runs(function() {
              ...
              return expect(wordElement.querySelector('.snippet-completion').textContent).toBe('something');
            });
          });
      ...
      return describe("when the matched prefix is highlighted", function() {
        it('highlights the prefix of the word in the suggestion list', function() {
          spyOn(provider, 'requestHandler').andCallFake(function(_arg) {
            var prefix;
            prefix = _arg.prefix;
            return [
              {
        ...
        return describe("when the prefix does not match the word", function() {
          return it("does not render any character-match spans", function() {
            spyOn(provider, 'requestHandler').andCallFake(function(_arg) {
              var prefix;
              prefix = _arg.prefix;
              return [
