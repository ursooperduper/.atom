(function() {
  ...
  SuggestionListElement = (function(_super) {
    ...
    SuggestionListElement.prototype.renderItem = function(_arg, index) {
      var ch, className, displayHtml, hasRightLabel, highlightedChar, i, labelSpan, lastWordIndex, li, preChar, replacement, replacementPrefix, rightLabel, rightLabelHTML, snippet, text, wordIndex, wordSpan, _i, _len;
      ...
      if (_.isString(snippet)) {
        replacement = snippet.replace(this.snippetRegex, function(match, snippetText) {
