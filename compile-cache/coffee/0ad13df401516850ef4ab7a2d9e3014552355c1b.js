(function() {
  module.exports = {
    apply: function() {
      var applyBackgroundGradient, applyBackgroundImage, applyEditorFont, applyFont, applyFontWeight, applyTooltipContrast, body;
      body = document.querySelector('body');
      applyFont = function(font) {
        return body.setAttribute('isotope-light-ui-font', font);
      };
      applyFontWeight = function(weight) {
        return body.setAttribute('isotope-light-ui-fontweight', weight);
      };
      applyBackgroundGradient = function() {
        if (atom.config.get('isotope-light-ui.backgroundGradient')) {
          ...
          return body.setAttribute('isotope-light-ui-bg-gradient', 'false');
        }
      };
      ...
      applyTooltipContrast = function() {
        if (atom.config.get('isotope-light-ui.lowContrastTooltip')) {
          return body.setAttribute('isotope-light-ui-tooltip-lowcontrast', 'true');
        } else {
          return body.setAttribute('isotope-light-ui-tooltip-lowcontrast', 'false');
        }
      };
